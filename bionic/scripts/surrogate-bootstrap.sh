...
device_name=$(sudo python3 /tmp/get_surrogate_device.py)

# Partition the new root EBS volume
sudo sgdisk -Zg -n1:0:4095 -t1:EF02 -c1:GRUB -n2:0:0 -t2:BF01 -c2:ZFS ${device_name}
...
sudo chroot /mnt /tmp/chroot-bootstrap.sh ${device_name}
